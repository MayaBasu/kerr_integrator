...
pub fn integrate_theta(theta_initial:f64, params:ThetaParams) -> [[f64;2]; NUM_STEPS]{
...
fn integrate_chi(chi_initial:f64, params:ThetaParams) ->[[f64;2];NUM_STEPS] {
