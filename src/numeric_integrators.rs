...
use crate::structs::{Graph, RadialParams, StellarParams, ThetaParams};
use crate::functions::{find_radial_parameters,find_theta_parameters};

const STEP_SIZE: f64 = 0.001;
pub const NUM_STEPS: usize = 4000;

pub(crate) fn integrate_r(r_initial:f64, stellar_params: StellarParams) -> Vec<[f64;2]>{
...
pub(crate) fn integrate_theta(theta_initial:f64, stellar_params: StellarParams) -> Vec<[f64;2]>{
...
pub(crate) fn integrate_phi(radial_graph: Vec<[f64;2]>, theta_graph:Vec<[f64;2]>, stellar_params: StellarParams) -> Vec<[f64;2]>{
...
pub(crate) fn integrate_t(radial_graph: Vec<[f64;2]>, theta_graph:Vec<[f64;2]>, stellar_params: StellarParams) -> Vec<[f64;2]>{
...
pub fn integrate_geodesic(r_initial:f64, theta_initial:f64, stellar_params: StellarParams) ->(Vec<[f64;2]>,Vec<[f64;2]>,Vec<[f64;2]>,Vec<[f64;2]>){
    let radial_trajectory = integrate_r(r_initial,find_radial_parameters(lz,e,c));
    let theta_trajectory = integrate_theta(theta_initial,find_theta_parameters(lz,e,c));
